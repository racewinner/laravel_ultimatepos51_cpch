...
class SellController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ...
                ->editColumn('total_paid', function($row) use ($business) {
                ...
                ->editColumn('total_before_tax', function($row) use($business) {
                ...
                ->editColumn('types_of_service_name',
            ...
            $rawColumns = [ 'final_total','action', 'total_paid', 'document_type',
                            'total_remaining', 'payment_status', 'invoice_no', 'discount_amount', 
                            'tax_amount', 'total_before_tax', 'shipping_status', 'types_of_service_name', 
                            'payment_methods', 'return_due', 'contact_name', 'status'];
    ...
    public function getSellsOnDue($contact_id)
    {
        ...
        if (request()->ajax()) {
            ...
            $datatable = Datatables::of($sells)
                ...
                ->editColumn(
                    'total_before_tax', function($row) use($business) {
                        $total_before_tax = $row->total_before_tax;
                        $data_orig = $business->isMainCurrency($row->currency_id) ? "data-orig-value" : "data-orig-value-currency2";
                        return  '<span class="total-before-tax" ' . $data_orig . '="' . $total_before_tax . '" > '
                                . \App\Utils\Util::format_currency($total_before_tax, $row->currency, false)
            ...
            $rawColumns = [ 'final_total','action', 'total_paid', 'document_type',
                            'total_remaining', 'payment_status', 'invoice_no', 'discount_amount', 
                            'tax_amount', 'total_before_tax', 'return_due', 'contact_name', 'status'];
    ...
    public function edit($id)
    {
        ...
        return view('sell.edit')
            ->with(compact('business_details', 'currencies', 'taxes', 'sell_details', 'transaction', 
                'commission_agent', 'types', 'customer_groups', 'pos_settings', 'waiters', 
