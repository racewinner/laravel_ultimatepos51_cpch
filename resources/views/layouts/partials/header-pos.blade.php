...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    ...
    @endif
      ...
      class="btn btn-danger btn-flat m-6 btn-xs m-5 btn-modal pull-right" data-container=".close_register_modal"
    ...
    @endcan
      ...
      <button type="button" class="btn btn-danger btn-flat m-6 btn-xs m-5 pull-right popover-default" id="return_sale"
