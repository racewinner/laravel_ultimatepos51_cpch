        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[hide_recent_trans]',
    1,
    $pos_settings['hide_recent_trans'],
    ['class' => 'input-icheck']
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[disable_order_tax]',
    1,
    $pos_settings['disable_order_tax'],
    ['class' => 'input-icheck']
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[is_pos_subtotal_editable]',
    1,
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[enable_transaction_date]',
    1,
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[inline_service_staff]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[is_service_staff_required]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[disable_credit_sale_button]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[enable_weighing_scale]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[show_invoice_scheme]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[show_invoice_layout]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[show_pricing_on_product_sugesstion]',
    1,
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        {!! Form::checkbox(
    'pos_settings[enable_pin]',
    1,
    !empty($pos_settings['enable_pin']),
    ['class' => 'input-icheck']
