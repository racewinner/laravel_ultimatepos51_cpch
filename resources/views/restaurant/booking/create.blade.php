<div class="modal fade" id="add_booking_modal" tabindex="-1" role="dialog" 
	...
	$customers,
	null,
	['class' => 'form-control', 'id' => 'booking_customer_id', 'placeholder' => __('contact.customer'), 'required']
) !!}
	...
	$correspondents,
	null,
	['class' => 'form-control', 'placeholder' => __('restaurant.select_correspondent'), 'id' => 'correspondent']
) !!}
							</div>
						</div>
					</div>
