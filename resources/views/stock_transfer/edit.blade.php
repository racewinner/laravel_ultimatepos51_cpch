						...
						<div class="input-group">
							...
							<select name='currency_id' class='form-control select2' disabled>
								@foreach ($currencies as $currency)
									<option value={{ $currency->id }} {{ $currency->id == $sell_transfer->currency_id ? "selected" : "" }} data-thousand-separator={{ empty($currency->thousand_separator) ? "NA" : $currency->thousand_separator }} data-decimal-separator={{ empty($currency->decimal_separator) ? "NA" : $currency->decimal_separator}}
