...
@section('content')
  ...
  <section class="content">
    {!! Form::open([
    'url' => action([\App\Http\Controllers\PrinterController::class, 'update'], [$printer->id]),
    'method' => 'PUT',
    'id' => 'add_printer_form'
  ]) !!}
    ...
    'placeholder' => __('lang_v1.ip_address_help')
      ...
      <div class="col-sm-12 hide" id="path_div">
        ...
        <span class="help-block">
          <b>Connection Type Windows: </b> The device files will be along the lines of <code>LPT1</code> (parallel)
          or <code>COM1</code> (serial). <br />
          <b>Connection Type Linux: </b> Your printer device file will be somewhere like <code>/dev/lp0</code>
          (parallel), <code>/dev/usb/lp1</code> (USB), <code>/dev/ttyUSB0</code> (USB-Serial),
