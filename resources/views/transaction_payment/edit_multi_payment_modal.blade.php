            ...
            <div class="modal-body">
                ...
                <div class='d-flex align-items-center' style='position: absolute; top:30px; right: 50px;'>
                    <div class="d-flex align-items-center me-4">
                        ...
                        <input type='text' class="form-control w-150px" name='payment_ref_no'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='d-flex justify-content-center'>
                                            <input type='number' class='form-control pay-amount' name='pay_amount'
                                                data-sell-id='{{$paySell->id}}' data-payment-id='{{$paySell->payment_id}}'
                        ...
                        <div class="d-flex mt-4 payment_row align-items-start">
                            <div class="me-4">
                                ...
                                <div class="input-group ms-2">
                                    ...
                                    {!! Form::text(
    'paid_on',
    @format_datetime($payment_line?->paid_on ?? ''),
                            ...
                            @if($trans_type == 'sell')
                                <div class="invoice_container">
                                    @if($payment_line->pymo_invoice)
                                        ...
                                        <a class='m-2'
                                            href='/uploads/invoices/{{$payment_line->business_id}}/{{$payment_line->pymo_invoice}}.pdf'
                                            target='_blank'>@lang('invoice.download_document')</a>
                                    @else
                                        <button type="button" class="btn btn-default"
                                            id='generate_invoice_btn'>@lang('invoice.generate_invoice')</button>
                                    @endif
                                </div>
                            @endif
                            <div class="flex-fluid d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary"
                                    id='save_multi_pay'>@lang('messages.save')</button>
                                <button type="button" class="btn btn-default"
