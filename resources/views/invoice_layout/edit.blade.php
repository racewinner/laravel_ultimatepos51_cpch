...
<section class="content">
          ...
          <div class="form-group @if($invoice_layout->design != 'columnize-taxes') hide @endif" id="columnize-taxes">
            <div class="col-md-3">
              <input type="text" class="form-control" name="table_tax_headings[]" required="required"
                placeholder="tax 1 name" value="{{$invoice_layout->table_tax_headings[0]}}" @if($invoice_layout->design != 'columnize-taxes') disabled @endif>
  ...
  'show_letter_head',
  1,
  $invoice_layout->show_letter_head,
  ['class' => 'input-icheck', 'id' => 'show_letter_head']
        ...
        <div class="col-sm-6 letter_head_input">
          <div class="form-group">
            ...
            <span class="help-block">@lang('lang_v1.letter_head_help') <br>
              @lang('lang_v1.invoice_logo_help', ['max_size' => '1 MB']) <br> @lang('lang_v1.letter_head_help2')</span>
          </div>
        </div>
      </div>
  ...
  'placeholder' => __('invoice.invoice_heading_paid')
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[proforma_heading]', !empty($invoice_layout->common_settings['proforma_heading']) ? $invoice_layout->common_settings['proforma_heading'] : null, [
  'class' => 'form-control',
  ...
  'id' => 'proforma_heading'
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[sales_order_heading]', !empty($invoice_layout->common_settings['sales_order_heading']) ? $invoice_layout->common_settings['sales_order_heading'] : null, [
  'class' => 'form-control',
  ...
  'placeholder' => __('lang_v1.date_label')
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[due_date_label]', !empty($invoice_layout->common_settings['due_date_label']) ? $invoice_layout->common_settings['due_date_label'] : null, [
  'class' => 'form-control',
  ...
  'placeholder' => __('lang_v1.subtotal_label')
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[total_quantity_label]', !empty($invoice_layout->common_settings['total_quantity_label']) ? $invoice_layout->common_settings['total_quantity_label'] : null, [
  'class' => 'form-control',
  ...
  'id' => 'total_quantity_label'
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[item_discount_label]', !empty($invoice_layout->common_settings['item_discount_label']) ? $invoice_layout->common_settings['item_discount_label'] : null, [
  'class' => 'form-control',
  ...
  'id' => 'item_discount_label'
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[discounted_unit_price_label]', !empty($invoice_layout->common_settings['discounted_unit_price_label']) ? $invoice_layout->common_settings['discounted_unit_price_label'] : null, [
  'class' => 'form-control',
  ...
  'placeholder' => __('invoice.total_label')
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('common_settings[total_items_label]', !empty($invoice_layout->common_settings['total_items_label']) ? $invoice_layout->common_settings['total_items_label'] : null, [
  'class' => 'form-control',
