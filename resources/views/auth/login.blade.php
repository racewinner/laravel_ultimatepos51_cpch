...
@section('content')
    <div class="login-form col-md-12 col-xs-12 right-col-content d-flex flex-column align-items-center">
        <img src="/img/cpch_logo.png" style="width: 200px; height: 200px; margin-bottom: 30px;" />
        <form method="POST" action="{{ route('login') }}" id="login-form" style="width: 400px;">
            {{ csrf_field() }}
