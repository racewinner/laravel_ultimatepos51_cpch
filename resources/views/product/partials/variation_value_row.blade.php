...
<tr @if(!empty($variation_value_id)) data-variation_value_id="{{$variation_value_id}}" class="variation_value_row hide"
@endif>
    <td>
        {!! Form::text($name . '[' . $variation_index . '][variations][' . $value_index . '][sub_sku]', null, ['class' => 'form-control input-sm input_sub_sku']) !!}
        {!! Form::hidden(
    $name . '[' . $variation_index . '][variations][' . $value_index . '][is_hidden]',
    $is_variation_value_hidden,
    ['class' => 'is_variation_value_hidden']
) !!}
