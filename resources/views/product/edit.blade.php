...
{!! Form::open(['url' => action([\App\Http\Controllers\ProductController::class, 'update'] , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
      ...
      @if(!empty($product->sub_category->mercadolibre_category_id))
        ...
        @endif
      @else
        <p>The sub category has not yet synchronized with Mercado Libre.</p>
      @endif
    @endcomponent
...
@section('javascript')
  ...
  <script type="text/javascript">
    $(document).ready( function(){
      ...
      var ddd = {!! json_encode($mercadolibre_category_detail['item_conditions']) !!}
      var ddd1 = {!! json_encode($mercadolibre_listing_types) !!}
    });
  </script>
@endsection