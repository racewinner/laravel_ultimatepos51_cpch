                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 @if($key == 'send_ledger') hide @endif">
                            <div class="form-group">
                                ...
                                {!! Form::textarea(
                                    'template_data[' . $key . '][whatsapp_text]',
                                    $value['whatsapp_text'],
                                    [
                                        'class' => 'form-control'
                                        ,
                                        'placeholder' => __('lang_v1.whatsapp_text'),
                                        'id' => $key . '_whatsapp_text',
                                        'rows' => 6
                                    ]
                                ) !!}
                            </div>
