...
<section class="content">
  ...
  ['class' => 'input-icheck', 'id' => 'selected_contacts']
    ...
    <div class="col-md-12">
      ...
      <div class="col-sm-4">
        {!! Form::label('sale_pin', __('lang_v1.pin_for_sale')) !!}
        <div class="d-flex align-items-center">
          <div class="form-group flex-fluid">
  ...
  ['class' => 'input-icheck']
      ...
      <div class="col-sm-4">
        {!! Form::label('partner_pin', __('lang_v1.pin_for_partner')) !!}
        <div class="d-flex align-items-center">
          <div class="form-group flex-fluid">
            {!! Form::text('pin_partner', $user['pin_partner'], ['class' => 'form-control']) !!}
          </div>
          <div class="form-group">
            <div class="checkbox">
              <label>
