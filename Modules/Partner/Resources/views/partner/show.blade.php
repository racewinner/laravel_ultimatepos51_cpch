            ...
            <div class="row">
                <div class="col-sm-3 invoice-col">
                    <div class="form-group">
                        ...
                        <div style="display: flex">
                          <div class="partner-profile" style="flex-grow: 1">{{$partner?->debt2['first_month_have_charged_last']}}</div>
                          <div class="partner-profile" style="flex-grow: 1">
                              {{ \App\Utils\Util::format_currency($partner && $partner->debt2['first_month_have_charged_last'] ? $partner->debt2['monthly_fee'] : null, $partner?->debt2['currency']) }}
                          </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 invoice-col">
                    <div class="form-group">
                        ...
                        <div style="display: flex">
                          <div class="partner-profile" style="flex-grow: 1">{{$partner?->debt2['last_month_have_to_charge_after']}}</div>
                          <div class="partner-profile" style="flex-grow: 1">
                              {{ \App\Utils\Util::format_currency($partner?->debt2['monthly_fee'], $partner?->debt2['currency']) }}
                          </div>
                        </div>
                    </div>
                </div>
